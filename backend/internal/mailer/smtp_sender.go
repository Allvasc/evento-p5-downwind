...
func (s *SMTPSender) SendWelcome(ctx context.Context, to, fullName string) error {
	...
	html := fmt.Sprintf(`<div style="font-family:sans-serif;max-width:480px;margin:0 auto">
		...
		<p style="color:#57677e;line-height:1.5">Seu cadastro foi criado com sucesso. O P5 DownWind Day é o percurso do Riviera Wind até a P5 Kite House — transporte, apoio completo e estrutura do início ao fim. Você entra na água, a gente cuida do resto.</p>
